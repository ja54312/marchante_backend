...
func handler(request events.APIGatewayProxyRequest) (events.APIGatewayProxyResponse, error) {
	...
	insert, err := db.Exec("INSERT INTO orders (id_user, id_rol, id_type_category, id_market, name, price_pz, price_kg, created_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?)", bodyData.IDUser, bodyData.IDRol, bodyData.CategoryType, bodyData.IDMarket, bodyData.Name, bodyData.PricePZ, bodyData.PriceKG, datetime)
	if err != nil {
